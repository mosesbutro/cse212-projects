...
public static class Recursion
{
    ...
    {   
        ...
        // Check if result already exists in memory
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        // If this is the end position, add the current path to results
        if (maze.IsEnd(x, y))
        {
            results.Add(currPath.AsString()); // Use this to add your path to the results
            return;
        }
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            {
                // Clone the current path before recursion to avoid modifying it in-place
